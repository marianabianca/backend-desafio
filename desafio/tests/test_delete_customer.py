...
class CustomerTest(unittest.TestCase):
    ...
    def test_successful_delete_customer(self):
        ...
        # When
        response = self.app.delete(path, headers={"Content-Type": "application/json"})

        # Then
        self.assertEqual(204, response.status_code)
    

    def test_unsuccessful_delete_customer_invalid_id(self):
        # Given
        customer_id = 123
    ...
    def test_unsuccessful_delete_customer_not_found(self):
        # Given
        customer_id = 123
